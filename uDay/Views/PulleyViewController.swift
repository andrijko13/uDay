...
public let kPulleyDefaultCollapsedHeight: CGFloat = 68.0
public let kPulleyDefaultPartialRevealHeight: CGFloat = 264.0
...
open class PulleyViewController: UIViewController, PulleyDrawerViewControllerDelegate {
    ...
    public public(set) var primaryContentViewController: UIViewController! {
        willSet {
    ...
    public public(set) var drawerContentViewController: UIViewController! {
        willSet {
    ...
    public public(set) var drawerPosition: PulleyPosition = .collapsed {
        didSet {
    ...
    public var supportedPositions: [PulleyPosition] = PulleyPosition.all {
        didSet {
    ...
    public public(set) var currentDisplayMode: PulleyDisplayMode = .automatic {
        didSet {
            if self.isViewLoaded
            {
                self.view.setNeedsLayout()
    ...
    public var isAnimatingDrawerPosition: Bool = false
    ...
    public func getLeftSafeArea() -> CGFloat {
    ...
    public func getRightSafeArea() -> CGFloat {
     ...
     */
    public func maskBackgroundDimmingView() {
     ...
     */
    public func backgroundDimmingViewFrameForDrawerPosition(_ drawerPosition: CGFloat) -> CGRect {
        let cutoutHeight = (2 * drawerCornerRadius)
    ...
    public func syncDrawerContentViewSizeToMatchScrollPositionForSideDisplayMode() {
